...
function JokeCardItem({ card, index }: { card: JokeCard; index: number }) {
  return (
    <motion.div
      ...
      <header className="relative pt-12 pb-8 px-4 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto">
          <div className="flex items-center gap-4 justify-center mb-8">
            ...
            <span className="text-gold text-xl tracking-widest">
              {"\u2660 \u2665 \u2666 \u2663"}
            </span>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 mt-10">
            ...
            >
              ...
              <div
                ...
                style={{ boxShadow: "0 2px 12px oklch(0.42 0.18 25 / 0.7)" }}
              >
                {"\u2660"} THE LEGEND {"\u2660"}
              </div>
            </motion.div>
      ...
      <div className="relative py-6 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <span
            ...
            style={{ background: "oklch(0.18 0.06 160)" }}
          >
            The Roast
          </span>
        </div>
      ...
      <main className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {JOKES.map((card, i) => (
              <JokeCardItem key={card.label} card={card} index={i} />
            ))}
          </div>
        </div>
      </main>
